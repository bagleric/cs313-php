...
?>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <h5 class="display-4">Resources</h5> </div>
        </div>
<?php 
                    try
{
	...
	{
    echo '<div class="col-md-5 big-square"><a class="primary-text" href="'. $row['resource_url'] . '"><p>'. '<strong>' . $row['name'] . '</strong></p> <p>' . $row['description'] . '</p></a></div>';
	}
}
