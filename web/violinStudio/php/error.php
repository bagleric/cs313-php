...
<body>
    ...
    <div class="big-square">
        ...
        <p>We seem to have encountered an error processing your request. If you were attempting to login or create an account, check your email and password to make sure that they are correct.</p>
    </div>
</body>
